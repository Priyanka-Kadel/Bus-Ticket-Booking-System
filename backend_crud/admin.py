...
from backend_crud.models import Route,Schedule, Bus, Driver, BusSeatStatus, PassengerDetails, PassengerSeat
...
admin.site.register([Route,Schedule, Bus, Driver, PassengerDetails, PassengerSeat])
